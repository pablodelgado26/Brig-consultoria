...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "group-data-[side=left]:left-0 group-data-[side=right]:right-0 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
